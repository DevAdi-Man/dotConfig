vim.o.hidden = true -- Allow buffers to be hidden without saving (required for toggleterm)
...
-- Strip trailing whitespace in git commit messages (prevents commitlint header-trim errors)
